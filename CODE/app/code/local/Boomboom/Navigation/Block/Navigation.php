 ...
 * Catalog navigation
 */
class Boomboom_Navigation_Block_Navigation extends Mage_Catalog_Block_Navigation
{
    /**
        ...
        $isOutermost = false, $outermostItemClass = '', $childrenWrapClass = '', $noEventAttributes = false)
    {
		...
		// Removing event attribute
		// Only CSS will be used for top menu
		// If you still need to use varien/menu.js
        ...
        if (!empty($htmlChildren)) {
			...
			$html[] = '<input type="checkbox" class="toggle-menu">';
